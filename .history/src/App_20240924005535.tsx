...
const App: React.FC = () => {
  ...
  const [sector_product, setProduct] = React.useState(sector_products);
  const [desc, setTitle] = React.useState(sector_products);
  const [sector, setSector] = React.useState(sectors);
