...
const App: React.FC = () => {
  ...
  const sampleRepeatProducts = [...Array(24)].fill(
    <ProductCard
  ...
  const sampleSectorProducts = [...Array(2)].fill(sampleRepeatProducts);
  ...
  const [sector_product, setProducts] = useState(sampleSectorProducts);
  const [desc, setDesc] = useState(sampleSectorDescs);
